...
class CreateAdsPerformanceDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ads_performance_detail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ads_performance_detail');
    }
}
