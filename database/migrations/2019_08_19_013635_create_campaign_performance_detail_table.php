...
class CreateCampaignPerformanceDetailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('campaign_performance_detail', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('campaign_performance_detail');
    }
}
