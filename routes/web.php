...
Route::middleware(['auth','role:'.Roles::MP])->group(function () {
...
//    Route::resource('plans', 'PlanController', ['as' => 'mp']);
//    Route::resource('campaigns', 'CampaignController', ['as' => 'mp']);
//    Route::resource('adgroups', 'AdGroupController', ['as' => 'mp']);
//    Route::resource('ads', 'AdController', ['as' => 'mp']);
//    Route::resource('general', 'GeneralController', ['as' => 'mp']);
});
