                    ...
                    <ul id="menu_admin_users" class="nav nav-pills nav-fill">
                        <li class="nav-item m-0 p-0">
                            <a class="nav-link text-left" href="#">
                                <i class="fa fa-users"></i> SocialAccount Management</a>
                        </li>
                    </ul>
            ...
            <div class="table-wrapper table-responsive">
                <div class="table-title flex-fill">
                    <div class="row p-0 m-0">
                        <div >
                            <h2>Social Account <b>Management</b></h2>
                        </div>
                        <div class=" p-0 m-0 ml-auto">
                            <button onclick="getAddModal()" class="btn btn-primary" ><i class="fa fa-plus" aria-hidden="true"></i><span>Add New Acc</span></button>
                        </div>
                    </div>
                </div>
...
@endsection
@section('scripts')
    <script type="text/javascript" src="{{ asset('js/social_account.js') }}"></script>
